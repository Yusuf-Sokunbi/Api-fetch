...
async function fetchRandomNews(){
  try{
    // &apiKey=002d87bc756c4313976f182324fe1fdd
    //

     const apiUrl = ` https://newsapi.org/v2/top-headlines?country=q&pageSize=20&apikey=${apiKey}`;
...
function displayBlogs(articles){
  ...
  let yours = blogContainer.innerHTML
  console.log(yours)
